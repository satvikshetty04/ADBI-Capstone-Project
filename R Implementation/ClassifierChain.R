...
#Creating the learner for the CC model
lrn.cc = makeMultilabelClassifierChainsWrapper(makeLearner("classif.rpart", predict.type = "response"))

#Creating the task for the CC model
