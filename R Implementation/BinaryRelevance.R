...
# ---------------------------- Creating the BR model

#Creating the learner for the BR model
lrn.br = makeMultilabelBinaryRelevanceWrapper(makeLearner("classif.rpart", predict.type = "response"))

#Creating the task for the BR model
